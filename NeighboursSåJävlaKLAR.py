...
class NeighborsModel:
    ...
    def __update_world(self):
        ...
        for row_num in range(self.SIDE):
            for col_num in range(self.SIDE):
                middle_actor = self.world[row_num][col_num]
                unsatisfied = self.neighbourhood_check(row_num, col_num, unsatisfied, middle_actor)
    ...
    def calculate_satisfied_percentage(self,neighbours_count_list,middle_actor):
        neighbours_like_middle_actor = count(neighbours_count_list, middle_actor)
    ...
    def neighbourhood_check(self, row_num, col_num, unsatisfied, middle_actor):

        neighbours_count_list = self.neighbours_count(row_num,col_num,middle_actor)
        satisfied_percentage = self.calculate_satisfied_percentage(neighbours_count_list,middle_actor)
